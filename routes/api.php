...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/users/{userId}/followers-count', [UserController::class, 'getFollowersCount']);
    Route::get('/users/{userId}/following-count', [UserController::class, 'getFollowingCount']);
